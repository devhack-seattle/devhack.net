...
var ToText = /** @class */ (function () {
    function ToText(rrule, gettext, language, dateFormatter) {
        ...
        if (isPresent(this.origOptions.byweekday)) {
            var byweekday_1 = !isArray(this.origOptions.byweekday)
                ? [this.origOptions.byweekday]
                : this.origOptions.byweekday;
            var days = String(byweekday_1);
            var bysetpos = !isArray(this.origOptions.bysetpos)
                ? this.origOptions.bysetpos === undefined
                    ? []
                    : [this.origOptions.bysetpos]
                : this.origOptions.bysetpos;
            var combined = bysetpos.length === 0
                ? byweekday_1
                : bysetpos.flatMap(function (n) {
                    return byweekday_1.map(function (weekday) { return weekday.nth(n); });
                });
            this.byweekday = {
                allWeeks: combined.filter(function (weekday) {
                    return !weekday.n;
                }),
                someWeeks: combined.filter(function (weekday) {
